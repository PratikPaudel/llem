        ...
        <div className="space-y-4 text-blue-600">
          ...
          <div className="relative">
            <input
              ...
              className="placeholder-blue-400 text-blue-600 w-full h-14 px-6 pr-24 rounded-lg border border-blue-600 bg-white focus:outline-none focus:border-blue-700 focus:ring-1 focus:ring-blue-700 shadow-sm text-lg"
